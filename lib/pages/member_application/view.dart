...
class MembApplicationView extends StatefulWidget {
  const MembApplicationView({super.key});

  @override
  State<MembApplicationView> createState() => _MembApplicationViewState();
}

class _MembApplicationViewState extends State<MembApplicationView> {
                  ...
                  itemBuilder: (contex, index) => SingleChildScrollView(
                        child: Card(
                            child: _SampleCard(
                                ...
                                rcpt_dt: data[index]['RECEIPT_DT'].toString(),
                                memo_no: data[index]['MEMO_NO'].toString(),
                                tot_share: data[index]['TOT_SHARE'].toString(),
                                bankId: bankId)),
                      ));
            } else {
              return const Center(
...
class _SampleCard extends StatelessWidget {
  const _SampleCard(
      ...
      required this.memo_no,
      required this.tot_share,
      required this.bankId});
  final String sl_no;
  final String rcpt_dt;
  final String memo_no;
  final String tot_share;
  final String bankId;
